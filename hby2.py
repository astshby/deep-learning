#AlexNet 
#模型：增加两层卷积，384,576，kernel_size=3，padding=1 576,384，kernel_size=3，padding=1 
#调参：未变
...
net = nn.Sequential(
    ...
    nn.Conv2d(384, 576, kernel_size=3, padding=1), nn.ReLU(),
    nn.Conv2d(576, 384, kernel_size=3, padding=1), nn.ReLU(),
